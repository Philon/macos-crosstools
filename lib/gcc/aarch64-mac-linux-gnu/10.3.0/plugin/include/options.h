...
enum opt_code
{
  ...
  OPT_time = 1753,                           /* -time */
  OPT_time_ = 1754,                          /* -time= */
  OPT_tno_android_cc = 1755,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1756,                 /* -tno-android-ld */
  OPT_traditional = 1757,                    /* -traditional */
  OPT_traditional_cpp = 1758,                /* -traditional-cpp */
  OPT_tree_stats = 1759,                     /* -tree-stats */
  OPT_trigraphs = 1760,                      /* -trigraphs */
  OPT_type_stats = 1761,                     /* -type-stats */
  OPT_u = 1762,                              /* -u */
  OPT_undef = 1763,                          /* -undef */
  OPT_v = 1764,                              /* -v */
  OPT_version = 1765,                        /* -version */
  OPT_w = 1766,                              /* -w */
  OPT_wrapper = 1767,                        /* -wrapper */
  OPT_x = 1768,                              /* -x */
  OPT_z = 1769,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
