...
enum opt_code
{
  ...
  OPT_minline_thumb1_jumptable = 1213,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1214,                 /* -mlittle-endian */
  OPT_mlong_calls = 1215,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1216,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1217,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1218,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1219,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1220,               /* -mprint-tune-info */
  OPT_mpure_code = 1221,                     /* -mpure-code */
  OPT_mrestrict_it = 1222,                   /* -mrestrict-it */
  OPT_msched_prolog = 1223,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1224,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1225,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1226, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1227,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1228,                         /* -mthumb */
  OPT_mthumb_interwork = 1229,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1230,                  /* -mtls-dialect= */
  OPT_mtp_ = 1231,                           /* -mtp= */
  OPT_mtpcs_frame = 1232,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1233,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1234,                         /* -mtune= */
  OPT_munaligned_access = 1235,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1236,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1237,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1238,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1239,              /* -mword-relocations */
  OPT_n = 1240,                              /* -n */
  OPT_no_canonical_prefixes = 1241,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1242,              /* -no-integrated-cpp */
  OPT_no_pie = 1243,                         /* -no-pie */
  ...
  OPT_pie = 1256,                            /* -pie */
  OPT_pipe = 1257,                           /* -pipe */
  OPT_print_file_name_ = 1258,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1259,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1260,          /* -print-multi-directory */
  OPT_print_multi_lib = 1261,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1262,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1263,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1264,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1265,               /* -print-prog-name= */
  OPT_print_search_dirs = 1266,              /* -print-search-dirs */
  OPT_print_sysroot = 1267,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1268,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1269,                          /* -quiet */
  OPT_r = 1270,                              /* -r */
  OPT_remap = 1271,                          /* -remap */
  OPT_s = 1272,                              /* -s */
  OPT_save_temps = 1273,                     /* -save-temps */
  OPT_save_temps_ = 1274,                    /* -save-temps= */
  OPT_shared = 1275,                         /* -shared */
  OPT_shared_libgcc = 1276,                  /* -shared-libgcc */
  /* OPT_specs = 1277, */                    /* -specs */
  OPT_specs_ = 1278,                         /* -specs= */
  OPT_static = 1279,                         /* -static */
  OPT_static_libasan = 1280,                 /* -static-libasan */
  OPT_static_libgcc = 1281,                  /* -static-libgcc */
  ...
  OPT_static_pie = 1290,                     /* -static-pie */
  /* OPT_std_c__03 = 1291, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1292, */                /* -std=c++0x */
  OPT_std_c__11 = 1293,                      /* -std=c++11 */
  OPT_std_c__14 = 1294,                      /* -std=c++14 */
  OPT_std_c__17 = 1295,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1296, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1297, */                /* -std=c++1z */
  OPT_std_c__2a = 1298,                      /* -std=c++2a */
  OPT_std_c__98 = 1299,                      /* -std=c++98 */
  OPT_std_c11 = 1300,                        /* -std=c11 */
  OPT_std_c17 = 1301,                        /* -std=c17 */
  /* OPT_std_c18 = 1302, */                  /* -std=c18 */
  ...
  OPT_std_gnu__2a = 1321,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1322,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1323,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1324,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1325, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1326, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1327, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1328,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1329,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1330, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1331, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1332,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1333, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1334, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1335, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1336, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1337, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1338,                     /* -std=legacy */
  OPT_symbolic = 1339,                       /* -symbolic */
  OPT_t = 1340,                              /* -t */
  OPT_time = 1341,                           /* -time */
  OPT_time_ = 1342,                          /* -time= */
  OPT_traditional = 1343,                    /* -traditional */
  OPT_traditional_cpp = 1344,                /* -traditional-cpp */
  OPT_trigraphs = 1345,                      /* -trigraphs */
  OPT_u = 1346,                              /* -u */
  OPT_undef = 1347,                          /* -undef */
  OPT_v = 1348,                              /* -v */
  OPT_version = 1349,                        /* -version */
  OPT_w = 1350,                              /* -w */
  OPT_wrapper = 1351,                        /* -wrapper */
  OPT_x = 1352,                              /* -x */
  OPT_z = 1353,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
